...
def calculate_area_triangle(base, height):
    print(f'base is {base} and height is {height}')
    return base * height / 2


print('Exercise 1:', calculate_area_triangle(height=10, base=5))
...
print('Exercise 2:', simple_interest(principle=1000, rate=5, years=2))
...
print('Exercise 3:', apply_discount(price=100, discount=25))
...
print('Exercise 4: Convert 0°C to Fahrenheit:', convert_temperature(temp=0, unit='C'))
print('Exercise 4: Convert 32°F to Celsius:', convert_temperature(temp=32, unit='F'))
...
print('Exercise 6:', largest(1, 2, 3, 4, 5, 6, 7, 8, 9))
...
print('Exercise 8:', product(2, 5, 5, 5, 5, 54325, 6432664, 775463, 654, 53, 43, 2))
